package by.epam.project.database.pool;
...
public final class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        try {
            ...
            LOG.error("NumberFormatException. DEFAULT_POOL_SIZE = " + DEFAULT_POOL_SIZE, e);
    ...
    public void dispose() {
        ...
        try {
            ...
            LOG.warn("Driver has not been deregistered", e);
        }
    }
    ...
    private void closeConnectionsQueue(BlockingQueue<Connection> queue) throws SQLException {
        ...
        for (int i = 0; i < DEFAULT_POOL_SIZE; i++) {
            try {
                ((SafeConnection)queue.take()).reallyClose();
            } catch (InterruptedException e) {
