...
public class CarDao implements EntityDao<Car> {
    ...
    public List<Car> takeAll() throws ProjectException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                CarClass carClass = CarClass.valueOf(resultSet.getString(4).toUpperCase());
    ...
    public Car takeCar(int id) throws ProjectException {
        ...
        try {
            ...
            statement = connection.prepareStatement(GET_CAR_BY_ID);
            ...
            if (resultSet.next()) {
                ...
                car = new Car(id, name, dailyRentalPrice, carClass, rented);
            }
            else{
